...
architecture rtl of full_display2 is
    component conta
        generic	(
            MIN_COUNT : natural := 0;
...
begin
	...
	clock_reset <= not debounced_reset;
    B: conta GENERIC MAP(0, max_clk) PORT MAP (clk,clock_reset,enable_conta,open,cuenta);
